 ...
 */
final class Version20210310213758 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_E422D933C04985C5');
        $this->addSql('DROP INDEX IDX_E422D933D9ACD54A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__categorie_categorie AS SELECT categorie_source, categorie_target FROM categorie_categorie');
        $this->addSql('DROP TABLE categorie_categorie');
        $this->addSql('CREATE TABLE categorie_categorie (categorie_source INTEGER NOT NULL, categorie_target INTEGER NOT NULL, PRIMARY KEY(categorie_source, categorie_target), CONSTRAINT FK_E422D933D9ACD54A FOREIGN KEY (categorie_source) REFERENCES categorie (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E422D933C04985C5 FOREIGN KEY (categorie_target) REFERENCES categorie (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO categorie_categorie (categorie_source, categorie_target) SELECT categorie_source, categorie_target FROM __temp__categorie_categorie');
        $this->addSql('DROP TABLE __temp__categorie_categorie');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__peinture AS SELECT id, user_id, nom, largeur, hauteur, en_vente, prix, date_realisation, created_at, description, portfolio, slug, file FROM peinture');
        $this->addSql('DROP TABLE peinture');
        $this->addSql('CREATE TABLE peinture (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, largeur NUMERIC(6, 2) NOT NULL, hauteur NUMERIC(6, 2) DEFAULT NULL, en_vente BOOLEAN NOT NULL, prix NUMERIC(6, 2) DEFAULT NULL, date_realisation DATETIME NOT NULL, created_at DATETIME NOT NULL, description CLOB NOT NULL COLLATE BINARY, portfolio BOOLEAN NOT NULL, slug VARCHAR(255) NOT NULL COLLATE BINARY, file VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_8FB3A9D6A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO peinture (id, user_id, nom, largeur, hauteur, en_vente, prix, date_realisation, created_at, description, portfolio, slug, file) SELECT id, user_id, nom, largeur, hauteur, en_vente, prix, date_realisation, created_at, description, portfolio, slug, file FROM __temp__peinture');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__peinture AS SELECT id, user_id, nom, largeur, hauteur, en_vente, prix, date_realisation, created_at, description, portfolio, slug, file FROM peinture');
        $this->addSql('DROP TABLE peinture');
        $this->addSql('CREATE TABLE peinture (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, largeur NUMERIC(6, 2) NOT NULL, hauteur NUMERIC(6, 2) DEFAULT NULL, en_vente BOOLEAN NOT NULL, prix NUMERIC(6, 2) DEFAULT NULL, date_realisation DATETIME NOT NULL, created_at DATETIME NOT NULL, description CLOB NOT NULL, portfolio BOOLEAN NOT NULL, slug VARCHAR(255) NOT NULL, file VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO peinture (id, user_id, nom, largeur, hauteur, en_vente, prix, date_realisation, created_at, description, portfolio, slug, file) SELECT id, user_id, nom, largeur, hauteur, en_vente, prix, date_realisation, created_at, description, portfolio, slug, file FROM __temp__peinture');
        $this->addSql('DROP TABLE __temp__peinture');
        $this->addSql('CREATE INDEX IDX_8FB3A9D6A76ED395 ON peinture (user_id)');
    }
